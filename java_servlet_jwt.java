...
public class JWT extends HttpServlet {
  private static final String SHARED_KEY = "{my infoneedle token}";
  private static final String VENUE_ID  = "{my infoneedle venue_id}";
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    String redirectUrl = "https://www.infoneedle.com/access/" + VENUE_ID + "/jwt?jwt=" + jwtString;
